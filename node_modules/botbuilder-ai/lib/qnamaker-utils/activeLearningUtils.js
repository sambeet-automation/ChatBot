...
class ActiveLearningUtils {
    ...
    */
    static getLowScoreVariation(qnaSearchResults) {
    ...
    static includeForClustering(prevScore, currentScore, multiplier) {
        return (prevScore - currentScore) < (multiplier * Math.sqrt(prevScore));
    }
}
exports.ActiveLearningUtils = ActiveLearningUtils;
//# sourceMappingURL=activeLearningUtils.js.map