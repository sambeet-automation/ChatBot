export declare namespace ChineseDateTime {
    ...
    const DatePeriodTillRegex = "(?<till>与|和|到|至|--|-|—|——|~|–)";
    ...
    const FutureRegex = "(?<future>(后|(?<![一两几]\\s*)下|之后|未来(的)?))";
    ...
    const DescRegex = "(?<desc>pm|am|p\\.m\\.|a\\.m\\.|p|a)";
    ...
    const TimeApproximateDescSuffixRegex = "(之前|以前|以后|之后|前|后|左右)";
    ...
    const ParserConfigurationAfter = "(之后|以后|后)";
    ...
    const MergedAfterRegex = "(后|之后|後|之後)$";
